...
//      LOAD CONTENTS
        if(user.getRole() == 2){
            ...
            for(int nCtr = 0; nCtr < history.size(); nCtr++){
                if(history.get(nCtr).getUsername().equals(user.getUsername())){
...
//          LOAD CONTENTS
            ...
            for(int nCtr = 0; nCtr < history.size(); nCtr++){
                if(searchFld.getText().toLowerCase().contains(history.get(nCtr).getUsername().toLowerCase()) || 
                   ...
                   searchFld.getText().toLowerCase().equals(history.get(nCtr).getName().toLowerCase()) ||
                   history.get(nCtr).getUsername().toLowerCase().equals(searchFld.getText().toLowerCase())){
